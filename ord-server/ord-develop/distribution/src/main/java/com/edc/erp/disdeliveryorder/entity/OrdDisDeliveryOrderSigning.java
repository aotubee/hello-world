...
/**
 * 配销单签收(OrdDisDeliveryOrderSigning)实体类
 *
 * @author fxw
...
@NoArgsConstructor
@Builder
@Table(name = "ord_dis_delivery_order_signing")
@ApiModel(value = "OrdDisDeliveryOrderSigning", description = "配销单签收")
public class OrdDisDeliveryOrderSigning implements Serializable{
