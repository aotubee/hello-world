 ...
 */
@Slf4j
public class DisFirstDirOrderAsyncListener extends ImportListener<ImportFirstOrderDetail> {
    ...
    public DisFirstDirOrderAsyncListener() {
    }
    ...
    public void onException(Exception exception, AnalysisContext context) {
        log.error("FirstDisOrderDetailListener解析失败，发生异常:{}", exception.getMessage(), exception);
