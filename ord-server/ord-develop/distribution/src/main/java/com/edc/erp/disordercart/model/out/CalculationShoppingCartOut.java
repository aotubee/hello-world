package com.edc.erp.disordercart.model.out;
 ...
 */
@Data
public class CalculationShoppingCartOut extends BaseEntity {
    ...
    private List<CalculationOrderCycleOut> calculationOrderCycleOutList;
