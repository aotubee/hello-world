...
/**
 * 批发出货单(WholesaleShipment)实体类
 *
 * @author lx
 * @since 2022-11-02 15:21:56
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Table(name = "ord_wholesale_shipment")
@ApiModel(value = "WholesaleShipment", description = "批发出货单")
public class WholesaleShipment implements Serializable{
