 ...
 **/
@Data
public class HSWholesaleReturnDetail implements Serializable {
    private static final long serialVersionUID = 5032813538913393085L;
    ...
    @ApiModelProperty(name = "isGift",value = "业务类型（1：销售，2：赠品）")
