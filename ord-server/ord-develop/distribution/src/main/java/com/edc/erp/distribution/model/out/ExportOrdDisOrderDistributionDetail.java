 ...
 */
@Data
public class ExportOrdDisOrderDistributionDetail {
     ...
     * 配销分货包装数
     */
    @Excel(name = "配销分货包装数", orderNum = "7", width = 15)
    private BigDecimal packingNumber;

    /**
     * 配销分货数量
     */
    @Excel(name = "配销分货数量", orderNum = "8", width = 15)
    private BigDecimal distributionQuantity;

    /**
     * 配销分货金额
     */
    @Excel(name = "配销分货金额", orderNum = "9", width = 15)
    private BigDecimal distributionAmount;

    /**
     * 配销价
     */
    @Excel(name = "配销价", orderNum = "10", width = 15)
