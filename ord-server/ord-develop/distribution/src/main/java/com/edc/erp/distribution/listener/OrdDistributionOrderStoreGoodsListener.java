 ...
 *
 * @author yaojinpeng
 * @since 2022/10/19 12:02
 */
@Slf4j
@Data
public class OrdDistributionOrderStoreGoodsListener extends ImportListener<ImportOrdDistributionStoreGoodsVO>{
    ...
    public OrdDistributionOrderStoreGoodsListener(AppUserService userService, StoreCenterService storeCenterService, OrderGoodsServer orderGoodsServer) {
    ...
    public void invoke(ImportOrdDistributionStoreGoodsVO data, AnalysisContext context) {
        ...
        //校验门店是否是配销
        Assert.isTrue(StoreConstant.StoreProperty.FRANCHISE.getMytValue().equals(storeOut.getStoreType()),() ->{
            throw new BusinessException(data.getStoreCode() + "门店是直营门店，不可在配销管理分货！;");
        });

        List<String> codes;
        Map<String, ImportOrdDistributionStoreGoodsVO> datas;
...
//     * @return
//     */
//    public OrderGoodsOut checkGoodsInfo(ImportOrdDistributionStoreGoodsVO data){
//        //查询允许分货商品信息入参
...
//        });
//        Assert.isTrue(NumberUtil.INTEGER_ONE.equals(goodsStatusBusinessSwitch.getIsAllotDis()), () ->{
//            throw new BusinessException("商品" + data.getSkuCode() + "不可被分货;");
//        });
//
//        //门店商品上下架
...
//    }
    ...
    public String checkGoodsInfoAndInitData(){
        ...
        for (Map.Entry<String, List<String>> storeListEntry : storeGoodsMap.entrySet()) {
            ...
            Map<String, ImportOrdDistributionStoreGoodsVO> storeGoodsVOMap = storeDataMap.get(storeCode);
            ...
            for (OrderGoodsOut goodsOut : goodsOuts) {
                ...
                ImportOrdDistributionStoreGoodsVO dataVo = storeGoodsVOMap.get(goodsOut.getGoodsCode());
                storeGoodsVOMap.remove(goodsOut.getGoodsCode());
     ...
     * @param
     */
    private void initDetail(ImportOrdDistributionStoreGoodsVO data,StoreOut storeOut,OrderGoodsOut orderGoodsOut) {
        //结果集
    ...
    public Response<List<OrdDisOrderDistributionDetailOut>> getResponse() {
        /**按照商品代码和门店代码对导入的数据去重*/
//        List<OrdDisOrderDistributionDetailOut> detailOuts = distributionStoreGoodsList.stream().collect(
...
//        );
        ...
        List<OrdDisOrderDistributionDetailOut> detailOuts = distributionStoreGoodsList;
        String message = "";
    ...
    public void doAfterAllAnalysed(AnalysisContext context) {
        ...
        log.info("ordDistributionOrderStoreGoodsListener解析完成");
    }

    @Override
    public void onException(Exception exception, AnalysisContext context) {
        log.error("ordDistributionOrderStoreGoodsListener，发生异常:{}", exception.getMessage(), exception);
