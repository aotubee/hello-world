 ...
 */
@Slf4j
public class OrdDisReturnGoodsListener extends ImportListener<ImportOrdReturnNoticeGoods> {
    ...
    public OrdDisReturnGoodsListener(OrderGoodsServer orderGoodsServer, List<String> goodsCodes,String bizOrgCode) {
        this.orderGoodsServer = orderGoodsServer;
        this.goodsCodes = goodsCodes;
        this.bizOrgCode = bizOrgCode;
    }

    public OrdDisReturnGoodsListener() {
    }
