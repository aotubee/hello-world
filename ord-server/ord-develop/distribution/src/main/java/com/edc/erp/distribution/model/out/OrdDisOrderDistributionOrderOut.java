...
/**
 * ordDistributionOrderOut返回类
 *
 * @author yaojinpeng
 * @since 2022/10/18 17:29
 */
@Data
public class OrdDisOrderDistributionOrderOut implements Serializable {
     ...
     * 配送中心中文
     */
    @ApiModelProperty(name = "distributionCenterValue", value = "配送中心中文")
    private String distributionCenterValue;
