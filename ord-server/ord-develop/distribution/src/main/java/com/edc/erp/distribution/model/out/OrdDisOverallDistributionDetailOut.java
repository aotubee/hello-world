 ...
 **/
@Data
public class OrdDisOverallDistributionDetailOut implements Serializable {
    private static final long serialVersionUID = 5252950018203581757L;

    /**
     * 直营分货单ID
     */
    @ApiModelProperty(name = "distributionOrderId", value = "配销分货单ID")
    ...
    @ApiModelProperty(name = "distributionIdentificationStr", value = "分货标识中文")
    private String distributionIdentificationStr;

    /**
     * 直营分货状态中文
     */
    @ApiModelProperty(name = "distributionOrderStatusStr", value = "配销分货状态中文")
    ...
    private List<OrdDisOverallDistributionStoreOut> distributionStoreOutList;
}
