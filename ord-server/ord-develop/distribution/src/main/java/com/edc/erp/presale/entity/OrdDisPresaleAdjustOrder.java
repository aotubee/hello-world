...
@NoArgsConstructor
@Builder
@Table(name = "ord_dis_presale_adjust_order")
@ApiModel(value = "OrdDisPresaleAdjustOrder", description = "预售调整单")
public class OrdDisPresaleAdjustOrder implements Serializable {
