...
/**
 * 配销差异单详细表(OrdDisDelivDifferenceDetail)实体类
 *
 * @author weichao
...
@NoArgsConstructor
@Builder
@Table(name = "ord_dis_deliv_difference_detail")
@ApiModel(value = "OrdDisDelivDifferenceDetail", description = "配销差异单详细表")
public class OrdDisDelivDifferenceDetail implements Serializable{
    ...
    /** 配销差异单主键 */
    @ApiModelProperty(name = "differenceOrderId", value = "配销差异单主键")
