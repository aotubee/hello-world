 ...
 */
@Data
public class DisDeliveryOrderOut extends OrdDisDelivery implements Serializable {
    ...
    @ApiModelProperty(name = "ordDisDeliveryDetailList", value = "配销单明细")
    private List<OrdDisDeliveryDetail> ordDisDeliveryDetailList;
