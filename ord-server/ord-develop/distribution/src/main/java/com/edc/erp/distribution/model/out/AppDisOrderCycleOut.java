...
import com.edc.erp.distribution.model.out.AppDisOrderOut;
 ...
 */
@Data
public class AppDisOrderCycleOut extends BaseEntity {
    ...
    private List<AppDisOrderOut> appOrderOutList;
}
