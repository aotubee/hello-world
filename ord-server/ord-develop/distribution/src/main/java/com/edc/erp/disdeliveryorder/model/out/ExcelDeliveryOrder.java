...
public class ExcelDeliveryOrder {
     ...
     * 配销单号
     */
    @ExcelProperty(value = "配销单号", index = 1)
    ...
    /** 集货数量 */
    @ExcelProperty(value = "集货数",index = 10,converter = BigDecimalConverter.class)
    private BigDecimal orderQuantity;

    /** 集货金额 */
    @ExcelProperty(value = "集货金额",index = 11,converter = BigDecimalAmountConverter.class)
    private BigDecimal orderAmount;

    /**
     * 配销数量
     */
    @ExcelProperty(value = "配销数量", index = 12,converter = BigDecimalConverter.class)
    private BigDecimal distributionQuantity;

    /**
     * 配销金额
     */
    @ExcelProperty(value = "配销金额", index = 13,converter = BigDecimalAmountConverter.class)
     ...
     * 集货单号
     */
    @ExcelProperty(value = "集货单号", index = 16)
     ...
     * 创建时间
     */
    @ExcelProperty(value = "创建时间", index = 22,converter = LocalDateTimeConverter.class)
