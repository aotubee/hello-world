 ...
 */
@Data
public class DisDeliveryOrderPrintOut implements Serializable {

    private static final long serialVersionUID = 7780225678921659902L;
    ...
    /** 创建时间 */
    @ApiModelProperty(name = "dtlPrintOuts", value = "配销单明细")
    private List<DisDeliveryOrderDtlPrintOut> dtlPrintOuts;
