 ...
 **/
@Data
public class ZKWholesaleReturnBackIn implements Serializable {
    private static final long serialVersionUID = -3041970582121212161L;
    ...
    private List<ZKWholesaleReturnDetailBackIn> detailList;
}
