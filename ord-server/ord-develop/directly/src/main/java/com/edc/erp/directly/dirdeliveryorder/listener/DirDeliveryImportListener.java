...
//
//import static com.edc.erp.directly.constant.CharConstant.Char.UNDERLINE;
//
///**
// * @author fxw
// * @description: 配货单批量导入监听器
// * @since 2022/11/17 15:16
// */
//@Slf4j
//public class DirDeliveryImportListener extends ImportListener<ImportDirDeliveryOrder>{
//
//    /**
...
//
//    public DirDeliveryImportListener(OrderGoodsServer orderGoodsServer,
//                                     StoreCenterService storeCenterService,
//                                     OrdDirDeliveryDetailService ordDirDeliveryDetailService,
//                                     StockServer stockServer,
//                                     String bizOrgCode){
//        this.orderGoodsServer = orderGoodsServer;
//        this.storeCenterService = storeCenterService;
//        this.ordDirDeliveryDetailService = ordDirDeliveryDetailService;
//        this.stockServer = stockServer;
//        this.bizOrgCode = bizOrgCode;
//    }
//
//    public DirDeliveryImportListener(){
//
//    }
//
...
//            if (dataMap.containsKey(storeCode.concat(UNDERLINE).concat(goodsCode))){
...
//     * @param data
//     */
//    public void verifyDetailIsExist(String mapKey,Map<String, String> errorMap,ImportDirDeliveryOrder data,StringBuilder errorBuilder){
////        WarehouseInfoOut warehouseInfoOut = stockServer.getWarehouseInfoByCode(data.getWrhCode(), bizOrgCode);
////        if (Objects.isNull(warehouseInfoOut)){
////            errorBuilder.append("仓储不存在");
////        }
...
//        }
//
//       StockInfoOut stockInfoByCode = ordDirDeliveryDetailService.findStockInfoByCode(data.getStockCode(), bizOrgCode);
...
//            errorBuilder.append("门店不存在或者门店不允许配货;");
//        }
//        String goodsCode = data.getGoodsCode();
...
//                errorBuilder.append(goodsCode).append("配送价为空");
//            }
//            boolean isCauPag = true;
//            if (NumberUtil.INTEGER_ZERO.toString().equals(data.getDeliveryQuantity()) || ! cn.hutool.core.util.NumberUtil.isInteger(data.getDeliveryQuantity().toString())){
//                errorBuilder.append("配货数量不可为小数或0;");
//                isCauPag = false;
//            }
//            boolean isError = isCauPag && Objects.nonNull(goodsOut.getDistributionSpecification()) &&
//                    (0 == (data.getDeliveryQuantity() / goodsOut.getDistributionSpecification().getQpc()) || 0 != (data.getDeliveryQuantity() % goodsOut.getDistributionSpecification().getQpc()));
//            if (isError) {
//                errorBuilder.append("配货包装数量不可为小数或0;");
//            }
//        }
//    }
...
//        log.error("DirDeliveryImportListener解析失败，发生异常:{}", exception.getMessage(), exception);
