...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_order_distribution_result")
@ApiModel(value = "OrdDirOrderDistributionResult", description = "直营分货单结果")
public class OrdDirOrderDistributionResult implements Serializable {
