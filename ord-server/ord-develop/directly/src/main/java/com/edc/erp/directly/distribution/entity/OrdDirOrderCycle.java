...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_order_cycle")
@ApiModel(value = "OrdDirOrderCycle", description = "订货周期")
public class OrdDirOrderCycle implements Serializable {
    ...
    /** 本周期第一笔订单提交时间 */
    @ApiModelProperty(name = "firstOrderTime", value = "本周期第一笔订单提交时间")
