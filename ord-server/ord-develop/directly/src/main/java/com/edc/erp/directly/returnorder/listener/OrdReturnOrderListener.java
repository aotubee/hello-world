...
//        }
//
//        boolean flag = stockServer.getReturnStockStatus(StoreConstant.StoreProperty.DIRECTLY.getMytValue(), stockCode, bizOrgCode);
//        if (!flag) {
//            throw new BusinessException(stockCode + "仓位不允许配货退货");
//        }
