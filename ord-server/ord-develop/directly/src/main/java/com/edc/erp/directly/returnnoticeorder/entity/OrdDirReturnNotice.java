...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_return_notice")
@ApiModel(value = "OrdDirReturnNotice", description = "退货通知单表")
public class OrdDirReturnNotice implements Serializable{
    ...
    /** 退货通知单单号 */
    @ApiModelProperty(name = "returnNoticeOrderNo", value = "退货通知单单号")
    ...
    /** 退货原因 */
    @ApiModelProperty(name = "returnWhy", value = "退货原因")
