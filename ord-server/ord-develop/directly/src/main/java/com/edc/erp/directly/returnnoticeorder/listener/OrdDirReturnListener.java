...
import com.edc.erp.directly.returnnoticeorder.model.in.ImportOrdReturnNoticeDetail;
...
@Slf4j
public class OrdDirReturnListener extends ImportListener<ImportOrdReturnNoticeDetail> {
    ...
    public OrdDirReturnListener(StoreCenterService storeCenterService, OrderGoodsServer orderGoodsServer, String bizOrgCode, String returnType, Map<String, Map<String, String>> detailMap) {
    ...
    public void invoke(ImportOrdReturnNoticeDetail data, AnalysisContext context) {
        ...
        if (Objects.isNull(storeOrderGoods.getDistributionUnitPrice())) {
            throw new BusinessException("门店" + data.getStoreCode() + "商品" + data.getGoodsCode() + "无配货价，请查证后添加;");
        }
        // 门店信息
