...
/**
 * 直营捞单池(OrdDisSalvageDelivPond)实体类
 *
 * @author zy
 */
@Data
...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_salvage_deliv_pond")
@ApiModel(value = "OrdDirSalvageDelivPond", description = "直营捞单池")
public class OrdDirSalvageDelivPond extends BaseEntity {
