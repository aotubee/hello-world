...
public enum OrderLogEnum {
    ...
    MANUAL_MATCHING_DELIVERY_AND_PURCHASE_ORDER("{0}将配货单{1}与订货订单{2}匹配成功，并匹配对账单配货量", "手动匹配配货单与订货订单，并更新对账单配货量"),
    ...
    ORDER_REQUEST_ORDER("订货单{0}匹配要货单{1}。", "订货单匹配要货单"),
