...
/**
 * 差异单(OrdDirDelivDifference)实体类
 *
 * @author weichao
 * @since 2022-11-14 11:32:44
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_deliv_difference")
@ApiModel(value = "OrdDirDelivDifference", description = "差异单")
public class OrdDirDelivDifference implements Serializable{
