...
/**
 * 直营捞单池明细(OrdDisSalvageDelivPondDetail)实体类
 *
 * @author zy
 */
@Data
...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_salvage_deliv_pond_detail")
@ApiModel(value = "OrdDirSalvageDelivPondDetail", description = "直营捞单池明细")
public class OrdDirSalvageDelivPondDetail extends BaseEntity {
