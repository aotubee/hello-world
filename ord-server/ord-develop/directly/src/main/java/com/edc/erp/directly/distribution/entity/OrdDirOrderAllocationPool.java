...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_order_allocation_pool")
@ApiModel(value = "OrdDirOrderAllocationPool", description = "门店订货调配表")
public class OrdDirOrderAllocationPool implements Serializable {
