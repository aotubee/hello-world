...
@NoArgsConstructor
@Builder
@Table(name = "opt_dir_order_process_config_item")
@ApiModel(value = "DirOrderProcessConfigItem", description = "订单类型流程选项配置")
public class DirOrderProcessConfigItem implements Serializable{
