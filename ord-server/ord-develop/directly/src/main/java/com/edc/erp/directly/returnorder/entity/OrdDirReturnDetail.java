...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_return_detail")
@ApiModel(value = "OrdDirReturnDetail", description = "退货单详情表")
public class OrdDirReturnDetail implements Serializable{
