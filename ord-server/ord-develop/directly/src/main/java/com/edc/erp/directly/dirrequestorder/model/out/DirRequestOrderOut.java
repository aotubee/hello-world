 ...
 */
@Data
public class DirRequestOrderOut extends AppQueryRequestOrderPageOut {
    ...
    private List<DirRequestOrderDetailOut> orderDetailOutList;

    @ApiModelProperty(name = "ordDirOrders", value = "订货单集合")
    private List<OrdDirOrder> ordDirOrders;

    @ApiModelProperty(name = "ordDirDeliveries", value = "配货单集合集合")
    private List<OrdDirDelivery> ordDirDeliveries;
}
