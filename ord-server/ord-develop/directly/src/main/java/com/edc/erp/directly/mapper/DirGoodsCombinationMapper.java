 ...
 */
@Repository
public interface DirGoodsCombinationMapper extends BaseMapper<DirGoodsCombination> {
     ...
     * @return
     */
    List<DirGoodsCombination> findByOrgCodeAndOrderTypeConfigIdList(@Param("bizOrgCode") String bizOrgCode,
