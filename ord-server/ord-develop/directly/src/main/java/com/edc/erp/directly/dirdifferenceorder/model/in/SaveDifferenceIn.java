...
public class SaveDifferenceIn {
    ...
    /** 差异单号 */
    @ApiModelProperty(name = "differenceNo", value = "直营配货差异单号")
    ...
    /** 差异单状态 */
    @ApiModelProperty(name = "differenceStatus", value = "直营配货差异单状态")
    ...
    /** 差异类型 */
    @ApiModelProperty(name = "differenceType", value = "直营配货差异类型")
    private String differenceType;

    /** 配货单号 */
    @ApiModelProperty(name = "deliveryOrderNo", value = "直营配货单号")
