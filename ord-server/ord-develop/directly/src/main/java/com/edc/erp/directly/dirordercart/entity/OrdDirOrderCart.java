package com.edc.erp.directly.dirordercart.entity;
...
@NoArgsConstructor
@Builder
@Table(name = "ord_dir_order_cart")
@ApiModel(value = "OrdDirOrderCart", description = "直营购物车")
public class OrdDirOrderCart implements Serializable{
    ...
    /** 商品数量 */
    @ApiModelProperty(name = "quantity", value = "商品包装数量")
