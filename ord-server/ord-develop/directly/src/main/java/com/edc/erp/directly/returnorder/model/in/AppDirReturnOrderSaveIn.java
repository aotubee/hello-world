...
/**
 * @ClassName AppReturnOrderSaveIn
 * @Description TODO
 * @Author ZhangYao
 * @CreateTime 2024/4/17 18:31
 **/
@Data
public class AppDirReturnOrderSaveIn implements Serializable {
    private static final long serialVersionUID = 108274950106802397L;
    ...
    private List<AppSaveOrdDirReturnDetailIn> returnGoodsInfoInList;
