...
/**
 * 直营订单类型流程副本(DirOrderProcessCopy)实体类
 *
 * @author fxw
...
@NoArgsConstructor
@Builder
@Table(name = "opt_dir_order_process_copy")
@ApiModel(value = "DirOrderProcessCopy", description = "直营订单类型流程副本")
public class DirOrderProcessCopy implements Serializable{
